...
public class GameServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (idString != null) {
                ...
                if (game == null) {
                    writer.println("Game not found. Please start a new game: <a href=\"Game2048?action=new\">New Game</a>");
                    return;
                }
    ...
    private String game2Html(UUID id, Game game) {
        ...
        sb.append("                <div class=\"col text-center pb-4\"><a role=\"button\" class=\"btn btn-secondary\" href=\"Game2048?id=" + id + "&action=up\"><i class=\"bi-arrow-up\"></i></a></div>\n");
        sb.append("                <div class=\"col-2\"></div>\n");
        sb.append("            </div>\n");
        sb.append("            <div class=\"row\">\n");
        sb.append("                <div class=\"col-2 my-auto text-right\"><a role=\"button\" class=\"btn btn-secondary\" href=\"Game2048?id=" + id + "&action=left\"><i class=\"bi-arrow-left\"></i></a></div>\n");
        sb.append("                <div class=\"col\">\n");
        ...
        sb.append("                    </div>\n");
        sb.append("                </div>\n");
        sb.append("                <div class=\"col-2 my-auto\"><a role=\"button\" class=\"btn btn-secondary\" href=\"Game2048?id=" + id + "&action=right\"><i class=\"bi-arrow-right\"></i></a></div>\n");
        sb.append("            </div>\n");
        sb.append("            <div class=\"row\">\n");
        sb.append("                <div class=\"col-2\"></div>\n");
        sb.append("                <div class=\"col text-center pt-4\"><a role=\"button\" class=\"btn btn-secondary\" href=\"Game2048?id=" + id + "&action=down\"><i class=\"bi-arrow-down\"></i></a></div>\n");
        sb.append("                <div class=\"col-2\"></div>\n");
        sb.append("            </div>\n");
        sb.append("            <div class=\"row\">\n");
        sb.append("                <div class=\"col text-center pt-4\"><a role=\"button\" class=\"btn btn-danger w-75\" href=\"Game2048?action=new\">New Game</a></div>\n");
        sb.append("                <div class=\"col text-center pt-4\"><a role=\"button\" class=\"btn btn-info w-75\" href=\"Game2048?id=" + id + "\">Refresh</a></div>\n");
        sb.append("            </div>\n");
        sb.append("        </div>\n");
        sb.append("        <div class=\"col-4\"></div>\n");
        sb.append("    </div>\n");
